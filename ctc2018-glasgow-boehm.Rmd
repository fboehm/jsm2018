...
- Enhanced mapping precision due to multiple founder lines
...
# @logan2013high and @recla2014precise

- Diversity Outbred mice
- 26 Behavioral phenotypes  
- Univariate QTL mapping revealed:
  - "Hot plate latency" maps to    
  - Both "Percent time in light" and "Distance traveled in light" map to 
...
library(knitr)
include_graphics("figs/all3.png")
```
